...
contract DemoCoin is BatchERC20, ERC20Detailed, Ownable {
    uint256 public constant INITIAL_SUPPLY = 10000 * (10 ** uint256(decimals()));

    constructor () public ERC20Detailed("DemoCoin", "DEMO", 18) {
...
contract DemoCoinCrowdsale is Crowdsale {
    constructor (address wallet, DemoCoin token) public Crowdsale(1, wallet, token) {
    }
}